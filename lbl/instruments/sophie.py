...
class Sophie(Instrument):
    def __init__(self, params: base_classes.ParamDict,
        ...
        self.default_template_name = 'LBL_Template_{0}_sophie.fits'
        self.default_mask_name = 'LBL_Mask_{obj}_{mtype}_sophie.fits'
        self.default_sample_wave_name = 'sample_wave_grid_sophie.fits'
    ...
    def param_override(self):
        ...
        self.param_set('APPROX_RESOLUTION', 75000, source=func_name)
