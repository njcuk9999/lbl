...
class NIRPS_HA(Instrument):
    ...
    def param_override(self):
        ...
        """
        # set function name
        func_name = __NAME__ + '.NIRPS_HA.param_override()'
...
class NIRPS_HE(Instrument):
    def __init__(self, params: base_classes.ParamDict):
        # call to super function
        super().__init__('NIRPS_HE')
        # set parameters for instrument
        self.params = params
        # override params
        self.param_override()
    ...
    def param_override(self):
        ...
        """
        # set function name
        func_name = __NAME__ + '.NIRPS_HE.param_override()'
        # set parameters to update
        self.params.set('INSTRUMENT', 'NIRPS_HA', source=func_name)
        # define the default science input files
        self.params.set('INPUT_FILE', '*.fits', source=func_name)
...
class NIRPS_HE_Geneva(NIRPS_HE):
    ...
    def param_override(self):
        """
        Parameter override for NIRPS_HE Geneva parameters
        (update default params)
