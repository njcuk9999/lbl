...
# Read APERO log lines pasted by the user and re-run the corresponding LBL recipe.
...
# Define variables
# =============================================================================
__NAME__ = 'lbl_apero_run.py'
__STRNAME__ = 'LBL Apero Run'
# -----------------------------------------------------------------------------
...
def get_user_input():
    ...
    Reads until two consecutive blank lines or EOF (Ctrl+D / Ctrl+Z).

    Returns:
        str: The pasted log text
    """
    print("=" * 80)
    print("Paste APERO log lines below.")
    ...
    # Strip trailing blank lines collected before the double-blank sentinel
...
def run_lbl_from_log(recipe_name: str, arguments: Dict[str, str]):
    ...
    print(", ".join(f"{k}={repr(v)}" for k, v in arguments.items()), end="")
    print(")")
    print("\n\n")
