...
if __name__ == "__main__":
    ...
    _ = lbl_reset(object_science=objs[num], object_comparison=templates[num],
                  **keyword_args)
    # run tellu-clean
    _ = lbl_telluclean(object_science=objs[num], object_comparison=templates[num],
                       telluclean_use_template=False,
                       **keyword_args)
    # run template
    _ = lbl_template(object_science=objs[num]+'_tc',
                     object_comparison=templates[num]+'_tc',
                     **keyword_args)
    # run tellu-clean
